...
def Header():
    return html.Div([
                ...
                html.Div([html.Img(src= "https://cdn.freebiesupply.com/logos/large/2x/python-3-logo-png-transparent.png", height='40'),
                    html.H1('Python Package Analyser',  style ={ 'textAlign':'center', 'color' : 'white'})
